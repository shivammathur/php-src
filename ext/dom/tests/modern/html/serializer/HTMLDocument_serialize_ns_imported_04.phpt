...
<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body><p>foo<container xmlns="urn:some:ns" xmlns:bar="urn:another:ns"/></p></body></html>
<html><head></head><body><p>foo<container xmlns="urn:some:ns" xmlns:bar="urn:another:ns"></container></p></body></html>
